...
function renderFixtureSummary(array $pflist)
{
    ...
    <div class="row details">
     	<section class="panel panel-primary">
			<div class="panel-body">
				<h3>
					<img width="24" src="img/clubs/lpl.png"><abbr title="FC Liverpool">Liverpool</abbr>
				...
				<p><strong>Liverpool vs {$pf->opp_full}</strong></p>
...
function renderKitTable(array $pkitlist)
{
    ...
    foreach ($pkitlist as $tk)
    {
        ...
        $trowdata .= "<tr>
                          ...
                          <td><img src=\"img/kits/{$tk->kitimage_href}\" width=\"100\"></img></td>
                          <td>{$tlink}</td>
                      </tr>";
    }
    $ttable = <<<TABLE
